      ...
      <div className="flex flex-col gap-2.5">
        {otherMethods.map((method) => (
          <div
            ...
            tabIndex={0}
            key={method.name}
            className="flex gap-5 border-2 border-gray-600 px-2.5 py-3 rounded-full items-center justify-center cursor-pointer hover:border-white transition-all duration-200 hover:scale-110"
          >
